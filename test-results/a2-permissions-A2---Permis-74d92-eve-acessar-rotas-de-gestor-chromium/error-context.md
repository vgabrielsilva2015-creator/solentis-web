...
- Name: a2-permissions.spec.ts >> A2 - Permissões e Segurança >> Operador não deve acessar rotas de gestor
- Location: tests\a2-permissions.spec.ts:17:7
