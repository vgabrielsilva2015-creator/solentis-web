...
- Name: rbac.spec.ts >> Testes Anti Pula-Pula (Segregação de Perfis) >> Técnico NÃO pode acessar dashboard do Operador
- Location: tests\rbac.spec.ts:30:7
...
Expected pattern: /.*\/tecnico\/dashboard/
