    ...
    <main className="min-h-screen flex items-center justify-center bg-slate-950 p-6">
      <div className="max-w-md text-center space-y-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
          ...
          <button onClick={() => window.location.href = '/'} className="inline-flex h-11 items-center justify-center rounded-lg bg-sky-500 px-6 font-medium text-white transition-colors hover:bg-sky-400">
            Voltar ao início
          </button>
        </div>
      </div>
