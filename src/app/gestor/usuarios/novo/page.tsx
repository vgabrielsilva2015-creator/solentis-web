    ...
    return (
      <div className="px-4 py-8 flex items-start justify-center relative min-h-[calc(100vh-80px)]">
        ...
        <div className="w-full max-w-sm space-y-4">
          <div className="rounded-xl border border-border bg-card p-6 space-y-4 shadow-xl">
            <div className="space-y-1">
              <h2 className="text-lg font-semibold text-foreground">Usuário criado</h2>
            ...
            <div className="flex gap-2 pt-1">
              <Button asChild className="w-full flex-1 bg-primary text-primary-foreground hover:bg-primary/90">
  ...
  return (
    <div className="px-4 py-8 flex items-start justify-center relative min-h-[calc(100vh-80px)]">
      ...
      <div className="w-full max-w-sm space-y-6">
        ...
        <div className="rounded-xl border border-border bg-card p-6 space-y-5 shadow-xl">
          <div className="space-y-1">
            <h2 className="text-lg font-semibold text-foreground">Novo usuário</h2>
            <p className="text-xs text-muted-foreground">Uma senha provisória será gerada automaticamente.</p>
          </div>
