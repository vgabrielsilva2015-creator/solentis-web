...
const FEATURES = [
  { title: 'Usuários',          desc: 'Cadastro e gerenciamento de contas' },
  { title: 'Relatórios',        desc: 'KPIs e exportação de dados' },
  { title: 'Parâmetros',        desc: 'Configuração de limites de qualidade' },
  { title: 'Equipamentos',      desc: 'Cadastro e manutenção preventiva' },
  { title: 'Ocorrências',       desc: 'Gestão de incidentes e resoluções' },
  { title: 'Turnos',            desc: 'Histórico e passagens de turno' },
]
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10 space-y-8">
        <div className="space-y-1">
          ...
          <p className="text-slate-400 text-sm">Painel do Gestor — funcionalidades em desenvolvimento.</p>
        </div>
