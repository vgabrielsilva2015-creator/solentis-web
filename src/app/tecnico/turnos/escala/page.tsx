...
// Escala (visualização) para o perfil Técnico — reaproveita o calendário
// read-only do operador, com navegação apontando para /tecnico.
export default async function TecnicoEscalaPage({ searchParams }: PageProps) {
  ...
  return (
    <main className="mx-auto max-w-lg px-4 py-6 space-y-6">
      <EscalaClient
        ...
        shifts={shifts}
        operators={operators}
        basePath="/tecnico/turnos/escala"
        backHref="/tecnico/dashboard"
      />
    </main>
  )
}
